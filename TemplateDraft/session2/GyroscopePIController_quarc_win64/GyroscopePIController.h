...
#ifndef RTW_HEADER_GyroscopePIController_h_
#define RTW_HEADER_GyroscopePIController_h_
#include <string.h>
#ifndef GyroscopePIController_COMMON_INCLUDES_
# define GyroscopePIController_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* GyroscopePIController_COMMON_INCLUDES_ */

#include "GyroscopePIController_types.h"
...
#define GyroscopePIController_rtModel  RT_MODEL_GyroscopePIControlle_T

/* Block signals (auto storage) */
typedef struct {
  real_T HILReadEncoder_o1;            /* '<S2>/HIL Read Encoder' */
  real_T HILReadEncoder_o2;            /* '<S2>/HIL Read Encoder' */
  real_T GYROEcountstorad;             /* '<S2>/GYRO-E: counts to rad' */
  real_T Gearratio;                    /* '<S2>/Gear ratio' */
  real_T NegFeedback;                  /* '<Root>/Neg. Feedback' */
  real_T ProportionalGain;             /* '<Root>/Proportional Gain' */
  real_T Integral;                     /* '<Root>/Integral' */
  real_T ManualSwitch;                 /* '<Root>/Manual Switch' */
  real_T DirectionConventionRightHandsys;/* '<S4>/Direction Convention: (Right-Hand) system' */
  ...
  real_T SRV02countstorad;             /* '<S2>/SRV02: counts to rad' */
  real_T Gain;                         /* '<S1>/Gain' */
  real_T Gain_i;                       /* '<S3>/Gain' */
  real_T NegativeFeedback;             /* '<Root>/Negative Feedback' */
  real_T IntegralGain;                 /* '<Root>/Integral Gain' */
  real_T Add;                          /* '<Root>/Add' */
} B_GyroscopePIController_T;
...
typedef struct {
  ...
  int32_T HILReadEncoder_Buffer[2];    /* '<S2>/HIL Read Encoder' */
  boolean_T HILInitialize_DOBits[8];   /* '<S2>/HIL Initialize' */
  t_boolean HILWriteDigital_Buffer[4]; /* '<S2>/HIL Write Digital' */
} DW_GyroscopePIController_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integral_CSTATE;              /* '<Root>/Integral' */
} X_GyroscopePIController_T;
...
/* State disabled  */
typedef struct {
  boolean_T Integral_CSTATE;           /* '<Root>/Integral' */
} XDis_GyroscopePIController_T;
...
#define rtB                            GyroscopePIController_B
#define BlockIO                        B_GyroscopePIController_T
#define rtX                            GyroscopePIController_X
#define ContinuousStates               X_GyroscopePIController_T
#define rtXdot                         GyroscopePIController_XDot
#define StateDerivatives               XDot_GyroscopePIController_T
#define tXdis                          GyroscopePIController_XDis
#define StateDisabled                  XDis_GyroscopePIController_T
#define rtP                            GyroscopePIController_P
#define Parameters                     P_GyroscopePIController_T
#define rtDWork                        GyroscopePIController_DW
#define D_Work                         DW_GyroscopePIController_T

/* Parameters (auto storage) */
struct P_GyroscopePIController_T_ {
...
struct tag_RTM_GyroscopePIController_T {
  const char_T *path;
...
extern P_GyroscopePIController_T GyroscopePIController_P;

/* Block signals (auto storage) */
extern B_GyroscopePIController_T GyroscopePIController_B;

/* Continuous states (auto storage) */
extern X_GyroscopePIController_T GyroscopePIController_X;

/* Block states (auto storage) */
extern DW_GyroscopePIController_T GyroscopePIController_DW;

/* Model entry point functions */
extern void GyroscopePIController_initialize(void);
extern void GyroscopePIController_output(void);
extern void GyroscopePIController_update(void);
extern void GyroscopePIController_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern GyroscopePIController_rtModel *GyroscopePIController(void);
...
extern RT_MODEL_GyroscopePIControlle_T *const GyroscopePIController_M;
 ...
 *
 * '<Root>' : 'GyroscopePIController'
 * '<S1>'   : 'GyroscopePIController/Beta: rad to deg'
 * '<S2>'   : 'GyroscopePIController/SRV02 Gyroscope'
 * '<S3>'   : 'GyroscopePIController/theta:  rad to deg'
 * '<S4>'   : 'GyroscopePIController/SRV02 Gyroscope/Actuator Dynamics'
 */
#endif                                 /* RTW_HEADER_GyroscopePIController_h_ */
