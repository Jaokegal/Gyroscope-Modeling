...
MODEL                = GyroscopePIController
MODULES              = GyroscopePIController_data.c GyroscopePIController_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = GyroscopePIController.mk
...
MODELLIB                  = GyroscopePIControllerlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = GyroscopePIController_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\gyroscope\Desktop\session2
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\GyroscopePIController_quarc_win64
